<html>
<head>
<title> Update Tuition Fee </title>
...
<body style="background-image:url(img/bg.png); background-size:100% 100%">
		...
		<div class="">			
			...
			<h2 class="w3-label w3-margin w3-text-teal"><i class="w3-xxlarge fa fa-arrow-left"></i> &nbsp;&nbsp;<i class="w3-xxlarge fa fa-edit"></i> Update Tuition Fee </h2></a>
		</div>
</body>
</html>